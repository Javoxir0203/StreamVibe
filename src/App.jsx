					...
					<header>
						<nav>
							<div className='container mx-auto flex items-center  py-7  justify-between '>
								...
								<div>
									<button className='bg-[#141414]'>
										<img src={search} alt='icon' />
									</button>

									<button className='bg-[#141414] ml-7'>
						...
						<div className='pb-12 pt-24 bg-[#0F0F0F]'>
							<div className=' flex items-start justify-between pb-24 '>
								...
								<ul>
									...
									<button className='rounded-lg p-4 bg-[#1A1A1A] border-[#262626] mr-3.5'>
										<img src={facebook} alt='icon' />
									</button>
									<button className='rounded-lg p-4 bg-[#1A1A1A] border-[#262626] mr-3.5'>
										<img src={twitter} alt='icon' />
									</button>
									<button className='rounded-lg p-4 bg-[#1A1A1A] border-[#262626] '>
										<img src={init} alt='icon' />
									</button>
								</ul>
							</div>
